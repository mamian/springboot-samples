package net.mamian.thriftDemoConsumer.config;
...
public class ZooKeeperConfig {
    ...
    // thrift实例列表
    public static Map<String, HelloWorldService.Client> serviceMap = new HashMap<String, HelloWorldService.Client>();
            ...
            public void handleChildChange(String parentPath,
                ...
                for (Map.Entry<String, HelloWorldService.Client> entry : serviceMap.entrySet()) {
                    ...
                    if (!currentChilds.contains(entry.getKey())) {
                        HelloWorldService.Client c = serviceMap.get(entry.getKey());
                        try {
    ...
    // 创建一个服务实例
    private HelloWorldService.Client createUserService(String serviceInstanceName) {
        ...
        return new HelloWorldService.Client(new TBinaryProtocol(transport));
    }
}
